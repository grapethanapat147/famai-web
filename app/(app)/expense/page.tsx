...
import { canManageExpense, type ExpenseRow } from "@/lib/expense/expenses";
...
export default async function ExpensePage() {
  ...
  const [expensesRes, categoriesRes, usersRes] = await Promise.all([
    supabase
      .from("expense")
      .select("id, category_id, spent_at, amount, vendor, tax_invoice_no, has_receipt, note, created_by")
