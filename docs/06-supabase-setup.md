...
**ที่มีอยู่ตอนนี้** 45 ตาราง · 59 นโยบาย RLS · รถ 50 คัน · บัญชีผู้ใช้ 9 ราย · ฐานข้อมูล 12 MB

12 MB จาก 500 MB — ที่เหลือรองรับได้อีกหลายปี ตัวที่โตเร็วที่สุดคือ `audit_log`
